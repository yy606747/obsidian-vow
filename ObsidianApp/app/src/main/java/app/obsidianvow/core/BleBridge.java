 ...
 *
 * 前端：
 *   window.ObsidianBle.configure(JSON.stringify({namePrefix:"CX492B",
 *       serviceUuid:"...", writeUuid:"...", notifyUuid:"...",
 *       framing:"raw", writeType:"no_response"}))
 *   window.ObsidianBle.connect() / disconnect() / isConnected() / sendData(hex)
 * 回调：toyNativeBle.onConnected() / onDisconnected() / onError(msg) / onLog(msg)
 */
@SuppressLint("MissingPermission")
public class BleBridge {

    private static final String TAG = "ObsidianBle";
