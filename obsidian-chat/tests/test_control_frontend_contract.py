...
def test_control_runtime_supports_refresh_recovery_and_owner_arbitration():
    ...
    assert "obsidian_tide_owner_client_id" in source
...
def test_control_scripts_are_cache_busted_for_app_webview():
    ...
    assert "/static/js/chat/control_runtime.js?v=20260905-brand" in html
    assert "/static/js/chat/toy_bridge.js?v=20260905-brand" in html
    assert "/static/js/chat/control_toy_router.js?v=20260905-brand" in html
    assert "/static/js/chat/realtime.js?v=20260905-brand" in html
    assert "/static/js/chat/send.js?v=20260905-brand" in html
    assert "/static/js/chat/messages.js?v=20260905-brand" in html
    assert "/static/js/chat/whisper_toy_facade.js?v=20260905-brand" in html
    assert "/static/js/chat/ai_dom_facade.js?v=20260905-brand" in html
    assert "/static/js/chat/ai_dom.js?v=20260905-brand" in facade
...
def test_toy_bridge_heartbeat_tracks_active_driver_connections():
    ...
    assert "window.ObsidianBle.isConnected()" in heartbeat_body
...
def test_control_emergency_stop_can_call_android_adv_bridge_directly():
    ...
    assert "global.ObsidianAdv.emergencyStop" in source
    assert "global.ObsidianAdv.stop" in source
...
def test_muse_ttl_stop_uses_broadcast_receiver_not_service_self_resurrection():
    service = (ROOT.parent / "ObsidianApp/app/src/main/java/app/obsidianvow/core/MuseForegroundService.java").read_text(encoding="utf-8")
    receiver = (ROOT.parent / "ObsidianApp/app/src/main/java/app/obsidianvow/core/MuseStopReceiver.java").read_text(encoding="utf-8")
    manifest = (ROOT.parent / "ObsidianApp/app/src/main/AndroidManifest.xml").read_text(encoding="utf-8")
