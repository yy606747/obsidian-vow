...
def test_gemini_defaults_are_tier_safe_and_memory_efficient(monkeypatch):
    ...
    monkeypatch.delenv("OBSIDIAN_MEMORY_EMBEDDING_PROVIDER", raising=False)
    monkeypatch.delenv("OBSIDIAN_MEMORY_EMBEDDING_MODEL", raising=False)
    monkeypatch.delenv("OBSIDIAN_MEMORY_EMBEDDING_DIMENSIONS", raising=False)
