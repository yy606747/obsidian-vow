...
function reportVisibleMessagesSeen() {
  ...
  if (!window.ObsidianNotifications || typeof window.ObsidianNotifications.seenThrough !== "function") return;
  ...
  if (seenThrough > 0) {
    try { window.ObsidianNotifications.seenThrough(seenThrough); } catch (e) {}
  }
}
