...
async function toyToggleConnect() {
  ...
  if (window.ObsidianBle) {
    if (window.ObsidianBle.configure && typeof AI_DOM_DEVICES !== 'undefined') {
      window.ObsidianBle.configure(JSON.stringify(AI_DOM_DEVICES.sosexy.native));
    }
