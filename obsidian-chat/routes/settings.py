...
async def get_settings():
    ...
    return {
        **image_history_config(SETTINGS),
        ...
        # 提示：哪些 key 已经被环境变量覆盖
        "env_overrides": {
            "gemini_key": bool(os.environ.get("OBSIDIAN_GEMINI_KEY")),
            "siliconflow_key": bool(os.environ.get("OBSIDIAN_SILICONFLOW_KEY")),
            "gemini_free_key": bool(os.environ.get("OBSIDIAN_GEMINI_FREE_KEY")),
            "aipro_key": bool(os.environ.get("OBSIDIAN_AIPRO_KEY")),
            "tavily_api_key": bool(os.environ.get("OBSIDIAN_TAVILY_API_KEY")),
            "netease_music_u": bool(os.environ.get("OBSIDIAN_NETEASE_MUSIC_U")),
        },
    }
