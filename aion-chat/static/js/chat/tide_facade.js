(function (global) {
  ...
  function refreshUi() {
    ...
    const supported = !!global.AionMuse?.isSupported?.();
  ...
  async function start() {
    ...
    if (!global.AionMuse?.isSupported?.()) {
  ...
  global.tideBuildControlSnapshot = () => ({ tide_mode: !!global.tideMode, toy_connected: !!global.AionMuse?.isSupported?.() });
