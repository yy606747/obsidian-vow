...
const VOICE_MESSAGE_SCRIPT = "/static/js/chat/voice_message.js?v=20260825-voice-input";
...
function openTideControl() {
  ...
  if (!tideFacadeLoadPromise) {
    tideFacadeLoadPromise = new Promise((resolve, reject) => {
      const script = document.createElement("script");
      script.src = "/static/js/chat/tide_facade.js?v=20260531-tide-ui3";
      script.async = true;
...
// ── 文件管理 ──
const FILE_MANAGER_SCRIPT = "/static/js/chat/file_manager.js";
