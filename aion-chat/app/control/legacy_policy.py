...
def control_legacy_toy_fallback_enabled() -> bool:
    return _flag("control_legacy_toy_fallback_enabled", "AION_CONTROL_LEGACY_TOY_FALLBACK")


def sentinel_legacy_toy_fallback_enabled() -> bool:
    return _flag("sentinel_legacy_toy_fallback_enabled", "AION_SENTINEL_LEGACY_TOY_FALLBACK")
