...
def test_screen_confirmation_countdown_times_out_and_rejects_late_click():
    request = screen.ScreenConfirmRequest("reason", timeout=2, ai_name="Aion")
...
def test_screen_confirmation_bridge_preserves_timed_out_function_attribute(
    ...
    assert screen.show_confirm_dialog("reason", timeout=30, ai_name="Aion")
    ...
    assert not screen.show_confirm_dialog("reason", timeout=30, ai_name="Aion")
