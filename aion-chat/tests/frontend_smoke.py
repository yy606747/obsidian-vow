...
Run this against a local backend, for example:
  AION_BIND_HOST=127.0.0.1 AION_BIND_PORT=18181 python main.py
    ...
    result.update(
        {
            ...
            "checks": {
                ...
                "debug_log_not_loaded_on_first_paint": not any(
                    "/static/js/chat/debug_log.js" in url for url in initial_request_urls
                ),
                ...
                "file_manager_not_loaded_on_first_paint": not any(
                    "/static/js/chat/file_manager.js" in url for url in initial_request_urls
                ),
                "file_manager_loaded_on_open": file_manager_lazy_loaded,
                "voice_not_loaded_on_first_paint": not any(
                    "/static/js/chat/voice.js" in url for url in initial_request_urls
                ),
                "voice_loaded_on_request": voice_lazy_loaded,
                "whisper_toy_not_loaded_on_first_paint": not any(
                    "/static/js/chat/whisper_toy.js" in url for url in initial_request_urls
                ),
                ...
                "aidom_not_loaded_on_first_paint": not any(
                    "/static/js/chat/ai_dom.js" in url for url in initial_request_urls
                ),
